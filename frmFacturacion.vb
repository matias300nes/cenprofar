...
#Region "   Botones"
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If CDbl(txtValorCambio.Text) > 1 Then
            If MessageBox.Show("Desea facturar con el tipo de moneda en DOLAR? Cambio Actual: " & txtValorCambio.Text, "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
        ...
        If cmbTipoComprobante.SelectedValue = TipoComp.NotaCreditoA Or cmbTipoComprobante.SelectedValue = TipoComp.NotaCreditoB Or _
                                     cmbTipoComprobante.SelectedValue = TipoComp.NotaDebitoA Or cmbTipoComprobante.SelectedValue = TipoComp.NotaDebitoB Then
            If MessageBox.Show("Desea reutilizar el/los remitos asociados?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Reutilizar = True
            End If
        End If
...
ContinuarSinPagoCliente:
                                            ...
                                            If NotaCredito = True And Reutilizar = False Then
                                                ...
                                                MsgBox("Debe anular el o los remitos asociados ( " & NroRemito & " ) a la factura Anulada", MsgBoxStyle.Information, "Atención")
                                            End If
