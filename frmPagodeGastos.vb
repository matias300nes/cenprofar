...
#Region "   Botones"
    ...
    Private Sub btnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If MessageBox.Show("Esta acción anulará el Pago y actualizará el estado del o los Gastos asociados." + vbCrLf + "Si existen Cheques Propios vinculados serán eliminados." + vbCrLf + "¿Está seguro que desea continuar?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
