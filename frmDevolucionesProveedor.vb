...
Public Class frmDevolucionesProveedor
    ...
    Private Sub grdItems_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdItems.CellEndEdit
        ...
        If e.ColumnIndex = ColumnasDelGridItems.Cod_Material Then
            ...
            SendKeys.Send("{TAB}")
            ' el sistema generará automaticamente un lote interno para el lote de proveedor
    ...
    Private Sub LlenarGridItems()
        ...
        If txtID.Text = "" Then
            SQL = "select ''as 'Id',''as 'Código',''as 'IdMaterial',''as 'CodMaterial',''as 'Material',''as Lote,''as 'Qty',''as 'IdUnidad',''as 'Unidad',convert(bit,0) as 'ManejaLote',''as 'LoteProv','' as 'Remito'"
        Else
                ...
                If bolModo Then
                    ...
                    Select Case res
                        Case -3
                            ...
                            Cancelar_Tran()
                        Case -2
                            Util.MsgStatus(Status1, "No se pudo actualizar el número de Devolución (Encabezado).", My.Resources.Resources.stop_error.ToBitmap)
                            Cancelar_Tran()
                        Case -1
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        ...
        'nbreformreportes = "Listado de Devoluciones a Proveedores por Código"

        'paramdevolucionproveedores.AgregarParametros("Código :", "STRING", "", False, CType(txtCODIGO.Text, Long).ToString, "", cnn)
        paramdevolucionproveedores.AgregarParametros("Código :", "STRING", "", False, txtCODIGO.Text.ToString, "", cnn)
