...
#Region "Procedimientos Formularios"
    ...
    Private Sub frmUnidades_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        SQL = "exec spUnidades_Select_All @Eliminado = 0"
    ...
    Private Function AgregarRegistro() As Integer
        ...
        Try
            ...
            Try
                ...
                Try
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spUnidades_Insert", param_id, param_codigo, param_nombre, param_useradd, param_res)
    ...
    Private Function ActualizarRegistro() As Integer
        ...
        Try
            ...
            Try
                ...
                Try
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spUnidades_Update", param_id, param_codigo, param_nombre, param_userupd, param_res)
                    'res = param_res.Value
        ...
        Try
            ...
            Try
                ...
                Try
                    ...
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spUnidades_Delete", param_id, param_userdel, param_res)
                    res = param_res.Value
                    ...
                    If res > 0 Then
                        ...
                        '    sqlstring = "UPDATE [dbo].[" & NameTable_Unidades & "] SET [Eliminado] = 1 WHERE Codigo = '" & txtCODIGO.Text & "'"
...
#Region "Botones"
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If ReglasNegocio() Then
            ...
            If bolpoliticas Then
                ...
                '        sqlstring = "INSERT INTO [dbo].[" & NameTable_Unidades & "] (ID, [Codigo],[Nombre],[Eliminado])" & _
                '                    " values ( " & txtID.Text & ", '" & txtCODIGO.Text.ToUpper & "', '" & txtNOMBRE.Text.ToUpper & "' , 0 )"

                '    Else
                '        sqlstring = "UPDATE [dbo].[" & NameTable_Unidades & "] SET [Codigo] = '" & txtCODIGO.Text.ToUpper & " ', " & _
    ...
    Private Sub btnActivar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnActivar.Click
        ...
        Try
            ...
            '    sqlstring = "UPDATE [dbo].[" & NameTable_Unidades & "] SET [Eliminado] = 0 WHERE Codigo = '" & grd.CurrentRow.Cells(1).Value & "'"
            '    tranWEB.Sql_Set(sqlstring)
