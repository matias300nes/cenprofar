...
Public Class frmFacturacion_Manual
...
#Region "Componentes Formulario"
    ...
    Private Sub frmFacturacion_Manual_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        btnAnular.Enabled = Not bolModo

        chkFacturaAnulada_CheckedChanged(sender, e)
...
#Region "Botones"
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        chkFacturaAnulada.Checked = False
            ...
            If bolpoliticas Then
                ...
                Else
                    ...
                    If MessageBox.Show("Está seguro que desea modificar la información de la factura seleccionada?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                        ...
                        If grd.CurrentRow.Cells(20).Value = True Then 'Or (grd.CurrentRow.Cells(20).Value = False And grd.CurrentRow.Cells(16).Value > 0) Then
    ...
    Private Function AgregarRegistro() As Integer
        ...
        Try
            ...
            Try
                ...
                param_ptovta.Value = txtPtoVta.Text
    ...
    Private Function ActualizarRegistro() As Integer
        ...
        Try
            ...
            Try
                ...
                param_FacturadaAnulada.ParameterName = "@FacturaAnulada"
                param_FacturadaAnulada.SqlDbType = SqlDbType.Bit
                param_FacturadaAnulada.Value = chkFacturaAnulada.Checked
                param_FacturadaAnulada.Direction = ParameterDirection.Input
                ...
                Try
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spFacturacionManual_Update", _
                                              ...
                                              param_Manual, param_FacturadaAnulada, param_ValorCambioFacturado, param_useradd, param_res)
...
#Region "Procedimientos"
    ...
    Private Sub asignarTags()
        ...
        txtTotal.Tag = "13"
        txtNota.Tag = "14"
        chkFacturaAnulada.Tag = "15"
        txtValorCambio.Tag = "23"
    End Sub
    ...
    Private Sub Verificar_Datos()
        ...
        If txtValorCambio.Text = "0" Or txtValorCambio.Text = "" Then
            Util.MsgStatus(Status1, "Debe ingresar un valor para el valor de cambio.", My.Resources.Resources.alert.ToBitmap)
            Util.MsgStatus(Status1, "Debe ingresar un valor para el valor de cambio.", My.Resources.Resources.alert.ToBitmap, True)
    ...
    Private Sub LlenarComboClientes()
        ...
        Try
            ds_Cli = SqlHelper.ExecuteDataset(connection, CommandType.Text, "select DISTINCT c.id, c.nombre " & _
                                " from Clientes c where c.eliminado=0 order by C.NOMBRE")
    ...
    Private Sub LlenarcmbTipoFactura()
...
#End Region
    ...
    Private Sub chkFacturaAnulada_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkFacturaAnulada.CheckedChanged
        btnAnular.Enabled = Not chkFacturaAnulada.Checked
    End Sub
End Class