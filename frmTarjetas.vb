...
#Region "Botones"
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If MessageBox.Show("Está seguro que desea eliminar la Tarjeta seleccionada?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
    ...
    Private Sub btnActivar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnActivar.Click
        ...
        If MessageBox.Show("Está por activar nuevamente la Tarjeta: " & grd.CurrentRow.Cells(2).Value.ToString & ". Desea continuar?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
        ...
        Try
            ...
            Util.MsgStatus(Status1, "La Tarjeta se activó correctamente.", My.Resources.ok.ToBitmap)
