...
Public Class frmRemitosSinPresupuesto
...
#End Region
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If btnAceptar.Text = "Guardar" Then
            ...
            '        If MessageBox.Show("El producto seleccionado ya existe, desea incrementar la cantidad asociada en el Remito?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
