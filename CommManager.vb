...
#Region "Manager Variables"
    ...
    Private _displayWindow As TextBox 'RichTextBox
    ...
    'Private comPort As New CommManager()
...
#Region "Manager Properties"
    ...
    ''' value
    ''' </summary>
    Public Property DisplayWindow() As TextBox 'RichTextBox
        Get
...
#Region "Manager Constructors"
    ...
    Public Sub New(ByVal baud As String, ByVal par As String, ByVal sBits As String, ByVal dBits As String, ByVal name As String, ByVal rtb As TextBox) 'RichTextBox)
        _baudRate = baud
        _parity = par
        _stopBits = sBits
        _dataBits = dBits
    ...
    Public Sub WriteData(ByVal msg As String)
        Select Case CurrentTransmissionType
            ...
            Case TransmissionType.Hex
                Try
                    'convert the message to bytºe array
