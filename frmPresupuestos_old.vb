...
Public Class frmPresupuestos_old
...
#Region "Eventos"
    ...
    Private Sub frmPresupuestos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        LlenarcmbEmpleados3_App(cmbAutoriza, ConnStringSEI)
    ...
    Private Sub grdItems_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdItems.CellEndEdit
        ...
        Try
            ...
            If e.ColumnIndex = ColumnasDelGridItems.Nombre_Material And _
                ...
                'Try
                '    cod_moneda = CodMonedaPres  '"PE"
                'Catch ex As Exception
                '    MsgBox("Debe colocar la moneda")
                '    Exit Sub
                'End Try

                'If ObtenerMoneda_App(cod_moneda, idmoneda, nombre, cod_moneda, valorcambio, ConnStringSEI) = 0 Then
                ...
                'grdItems.Rows(grdItems.CurrentRow.Index).Cells(ColumnasDelGridItems.ValorCambio).Value = valorcambio
    ...
    '            txtIVA.Focus()
    '        Else
    '            'txtIvaTotal.Text = Math.Round(CDbl(txtSubtotalPE.Text) * (CDbl(txtIVA.Text) / 100), 2)
    '            'txtTotal.Text = CDbl(txtSubtotalPE.Text) + CDbl(txtIvaTotal.Text)
    '            cmbCliente.Focus()
    '        End If
    '    End If
    'End Sub
    ...
    '        txtIVA.Focus()
    '    Else
    '        If txtSubtotalPE.Text = "" Then Exit Sub
    '        'txtIvaTotal.Text = Math.Round(CDbl(txtSubtotalPE.Text) * (CDbl(txtIVA.Text) / 100), 2)
    '        'txtTotal.Text = CDbl(txtSubtotalPE.Text) + CDbl(txtIvaTotal.Text)
    '    End If
    'End Sub
    ...
    Private Sub PicEmpleados_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PicEmpleados.Click
        ...
        ARRIBA = 90
        IZQUIERDA = Me.Left + 20
        texto_del_combo = cmbVendedores.Text.ToUpper.ToString
        f.ShowDialog()
        LlenarcmbEmpleados3_App(cmbVendedores, ConnStringSEI)
        LlenarcmbEmpleados3_App(cmbAutoriza, ConnStringSEI)
        cmbVendedores.Text = texto_del_combo
    End Sub
        ...
        If Permitir Then
            ...
            Try
                If grd.RowCount > 0 Then
                    ...
                    Else
                        rdTrafo_CheckedChanged(sender, e)
                        'chkMostrarCodigoMaterial.Location = New System.Drawing.Point(360, 495)
                    End If
                    ...
                    If MessageBox.Show("Está seguro que desea eliminar el item?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                        ...
                        Else
                            If Not (grdOfertaComercial.CurrentRow.Cells(ColumnasDelGridOfertaComercial.IdPresupOT_Det).Value Is DBNull.Value) Then
                                ...
                                Else
                                    MsgBox("El itema seleccionado está dentro de un remito. No se puede eliminar", MsgBoxStyle.Information, "Atención")
                                End If
                            Else
                                grdOfertaComercial.Rows.RemoveAt(cell.Index)
                                grdOfertaComercial.Refresh()
    ...
    Private Sub chkAnulados_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkAnulados.CheckedChanged
        ...
        If chkAnulados.Checked = True Then
            SQL = "exec spPresupuestos_Select_All @Eliminado = 1, @Estado = ''"
        Else
            If chkPresupuestosCumplidos.Checked = False Then
                SQL = "exec spPresupuestos_Select_All @Eliminado = 0, @Estado = ''"
            Else
                SQL = "exec spPresupuestos_Select_All @Eliminado = 0, @Estado = 'Cumplido'"
            End If
        End If
    ...
    Private Sub chkAgregarOfertaComercial_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkAgregarOfertaComercial.CheckedChanged
        ...
        If band = 1 Then
            ...
            'chkMostrarCodigoMaterial.Visible = chkAgregarOfertaComercial.Checked
            ...
            'chkSubtotalOfertaComercial.Visible = chkAgregarOfertaComercial.Checked
            ...
            'lblIva10Pre.Visible = chkAgregarOfertaComeovrcial.Checked
            'txtIva10Pre.Visible = chkAgregarOfertaComercial.Checked
            ...
            If chkAgregarOfertaComercial.Checked = True Then
                ...
                'chkMostrarCodigoMaterial.Location = New System.Drawing.Point(819, 486)  '511
                ...
                'If txtIvaOferta.Text = "" Then txtIvaOferta.Text = "0"

                'If CDbl(txtIvaOferta.Text) > 20 Then
                '    txtIva21Pre.Text = CDbl(txtIva21.Text) + CDbl(txtIvaOferta.Text)
                'Else
                '    If CDbl(txtIvaOferta.Text) > 10 Then
                '        txtIva10Pre.Text = CDbl(txtIva10.Text) + CDbl(txtIvaOferta.Text)
                '    End If
                'End If
    ...
    Private Sub grdOfertaComercial_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdOfertaComercial.CellEndEdit
        ...
        Try
            ...
            If e.ColumnIndex = ColumnasDelGridOfertaComercial.PreciosinIva Then
                ...
                txtSubtotalOferta.Text = FormatNumber(CDbl(txtSubtotalOferta.Text), 2)
        ...
        Catch ex As Exception
            ...
            MsgBox(ex.Message)
            MsgBox("error en Sub grdOfertaComercial_CellEndEdit", MsgBoxStyle.Critical, "Error")
        End Try
    ...
    'Private Sub chkSubtotalOferta_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkSubtotalOfertaComercial.CheckedChanged
    '    'If band = 1 Then

    '    txtSubtotalOferta.Enabled = False
    '    txtIvaOferta.Enabled = chkSubtotalOfertaComercial.Checked

    '    If chkSubtotalOfertaComercial.Checked = True Then
    ...
    'Private Sub txtSubtotalOferta_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '    If band = 1 Then
    '        If chkSubtotalOfertaComercial.Checked = True Then
    '            If e.KeyChar = ChrW(Keys.Enter) Then
    '                If txtSubtotalOferta.Text = "" Then
    '                    Exit Sub
    '                Else
    '                    txtIvaOferta.Focus()
    '                End If
    ...
    'Private Sub txtSubtotalOferta_TextChanged(sender As Object, e As EventArgs)
    '    If band = 1 Then
    '        If chkSubtotalOfertaComercial.Checked = True Then
    '            If txtSubtotalOferta.Text = "" Then
    '                Exit Sub
    ...
    '                If txtIvaOferta.Text = "" Then
    '                    txtMontoIvaOferta.Text = "0"
    '                    txtTotalOferta.Text = txtSubtotalOferta.Text
    '                Else
    '                    txtMontoIvaOferta.Text = Math.Round(CDbl(txtSubtotalOferta.Text) * (CDbl(txtIvaOferta.Text) / 100), 2)
    '                    txtTotalOferta.Text = Math.Round(CDbl(txtSubtotalOferta.Text) + (CDbl(txtMontoIvaOferta.Text)), 2)
    '                End If
    '                MontoFinalPresupuesto()
    '            End If
    '        End If
    ...
    'Private Sub txtIvaOferta_TextChanged(sender As Object, e As EventArgs) Handles txtIvaOferta.TextChanged
    '    If band = 1 Then
    '        If chkSubtotalOfertaComercial.Checked = True Then
    '            If txtSubtotalOferta.Text = "" Then
    '                Exit Sub
    ...
    Private Sub rdTrafo_CheckedChanged(sender As Object, e As EventArgs) Handles rdTrafo.CheckedChanged
        If bolModo = False And band = 1 Then
            ...
            'chkMostrarCodigoMaterial.Visible = Not rdTrafo.Checked
...
#Region "Botones"
    ...
    Public Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        'If MessageBox.Show("Desea generar un nuevo Presupuesto?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
        '    Exit Sub
        'End If
        ...
        ValorcambioDolar = CDbl(ObtenerMoneda_ValorCambioDolar(ConnStringSEI))

        If MessageBox.Show("Desea cotizar en Dólares el nuevo presupuesto?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            BuscarMoneda("DOLAR")
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If chkManoObra.Checked = True And CDbl(txtSubtotal.Text) > 0 Then
        ...
        If ReglasNegocio() Then
            ...
            If bolpoliticas Then
                ...
                If AbrirWord = True Then
                    ...
                    Util.MsgStatus(Status1, "Generando el archivo de WORD, espere un instante por favor.", My.Resources.Resources.alert.ToBitmap)
                    ...
                    Documento.Bookmarks.Item("NroPresupuesto").Range.Text = txtCODIGO.Text.ToString
                    Documento.Bookmarks.Item("NroPresupuesto2").Range.Text = txtCODIGO.Text.ToString
                    Documento.Bookmarks.Item("Cliente").Range.Text = IIf(txtCliente.Text = "", cmbClientes.Text.ToString, txtCliente.Text)
                    Documento.Bookmarks.Item("Cliente2").Range.Text = IIf(txtCliente.Text = "", cmbClientes.Text.ToString, txtCliente.Text)
                    Documento.Bookmarks.Item("Referencia").Range.Text = txtNombre.Text
                    Documento.Bookmarks.Item("Referencia2").Range.Text = txtNombre.Text
                    Documento.Bookmarks.Item("Usuario").Range.Text = cmbUsuarios.Text
                    Documento.Bookmarks.Item("dia").Range.Text = dtpFECHA.Value.Day
                    Documento.Bookmarks.Item("Mes").Range.Text = dtpFECHA.Value.Month
                    Documento.Bookmarks.Item("ano").Range.Text = dtpFECHA.Value.Year
                ...
                Util.MsgStatus(Status1, "El Presupuesto se generó correctamente.", My.Resources.Resources.ok.ToBitmap)
    ...
    Private Sub btnGenerarOC_Click(sender As Object, e As EventArgs) Handles btnGenerarOC.Click
        ...
        ''f.Origen_ListaDistribuidor = chkPrecioDistribuidor.Checked
        ''f.cmbMonedas.SelectedValue = txtIdMonedaPres.Text
        'f.MdiParent = MDIPrincipal
        'f.Show()
    End Sub
...
#Region "Procedimientos"
    ...
    Private Sub AsignarTags()
        ...
        'chkSubtotalOfertaComercial.Tag = CStr(ColumnasDelGrid.SubtotalOfertaComercial)
    ...
    Private Sub LlenarLista_Notas()
        ...
        Try
            'MsgBox("SELECT nota, obligatorio FROM Notas WHERE solodolar = " & IIf(txtCodMonedaPres.Text.ToUpper = "DO", "solodolar", "0") & " and eliminado = 0 ORDER BY Obligatorio DESC, Nota ASC")

            ds_Notas = SqlHelper.ExecuteDataset(conexionGenerica, CommandType.Text, "SELECT nota, obligatorio FROM Notas WHERE solodolar = " & IIf(txtCodMonedaPres.Text.ToUpper = "DO", "solodolar", "0") & " and eliminado = 0 ORDER BY Obligatorio DESC, Nota ASC")
            ds_Notas.Dispose()
    ...
    Private Sub Imprimir(ByVal codigo As String)
        ...
        If rdTrafo.Checked = True Then
            ...
            nbreformreportes = "Presupuesto Mantenimiento Transformador - Ensayos"
            Rpt2.SEI_Trafos_Ensayos(codigo, Rpt3)
        Else
            If chkAgregarOfertaComercial.Checked = True Then
                If chkManoObra.Checked = False Then
                    nbreformreportes = "Oferta Comercial"
                    Rpt.SEI_OfertaComercial(codigo, Rpt1, False)
                Else
                    nbreformreportes = "Mano de Obra"
                    Rpt.SEI_OfertaComercial(codigo, Rpt1, True)
                End If
            Else
    ...
    Private Sub HiloOcultarColumnasGridItems()
        Try
            ...
            grdItems.Columns(ColumnasDelGridItems.orden).Width = 50
        ...
        For i = 0 To grdItems.RowCount - 2
            ...
            If Not grdItems.Rows(i).Cells(ColumnasDelGridItems.PrecioLista).Value Is DBNull.Value Then
                ...
                If grdItems.Rows(i).Cells(ColumnasDelGridItems.Iva).Value = 21 Then
                    txtIva21.Text = CDbl(txtIva21.Text) + CDbl(IIf(grdItems.Rows(i).Cells(ColumnasDelGridItems.MontoIva).Value Is DBNull.Value, 0, grdItems.Rows(i).Cells(ColumnasDelGridItems.MontoIva).Value * IIf(grdItems.Rows(i).Cells(ColumnasDelGridItems.Qty).Value Is DBNull.Value, 0, grdItems.Rows(i).Cells(ColumnasDelGridItems.Qty).Value)))
                Else
    ...
    Private Function AgregarActualizar_Registro() As Integer
        ...
        Try
            ...
            Try
                ...
                'Dim param_totalPE As New SqlClient.SqlParameter
                'param_totalPE.ParameterName = "@totalPE"
                'param_totalPE.SqlDbType = SqlDbType.Decimal
                'param_totalPE.Precision = 18
                'param_totalPE.Scale = 2
                'param_totalPE.Value = 0 'CType(txtTotalPE.Text, Double)
                'param_totalPE.Direction = ParameterDirection.Input
                ...
                'Dim param_iva21PE As New SqlClient.SqlParameter
                'param_iva21PE.ParameterName = "@iva21PE"
                'param_iva21PE.SqlDbType = SqlDbType.Decimal
                'param_iva21PE.Precision = 18
                'param_iva21PE.Scale = 2
                'param_iva21PE.Value = 0 'txtIva21.Text
                'param_iva21PE.Direction = ParameterDirection.Input
                ...
                'Dim param_iva10PE As New SqlClient.SqlParameter
                'param_iva10PE.ParameterName = "@iva10PE"
                'param_iva10PE.SqlDbType = SqlDbType.Decimal
                'param_iva10PE.Precision = 18
                'param_iva10PE.Scale = 2
                'param_iva10PE.Value = 0 'txtIva10.Text
                'param_iva10PE.Direction = ParameterDirection.Input
                ...
                param_idvendedor.Value = cmbVendedores.SelectedValue
                ...
                Try
                    If bolModo = True Then
                        SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "spPresupuestos_Insert", _
                                            ...
                                            param_MostrarSubtotalMOOC, param_SubtotalOfertaComercial, _
                                            ...
                                            param_PrecioDistribuidor, param_res)
                    ...
                    Else
                        SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "spPresupuestos_Update", _
                                            param_id, param_codigo, param_fecha, param_idCliente, param_Comprador, param_idComprador, _
                                            param_Usuario, param_idUsuario, param_Entregaren, param_sitioentrega, _
                                            param_iva21DO, param_iva10DO, _
                                            param_subtotalDO, param_totalDO, _
                                            param_incluyenotas, param_validez, _
                                            param_formapago, param_NroOC, param_nroreq, param_nrorev, _
                ...
                For i = 0 To grdItems.RowCount - 2
                    ...
                    If Not (grdItems.Rows(i).Cells(ColumnasDelGridItems.Nombre_Material).Value Is DBNull.Value) Then
                        ...
                        If grdItems.Rows(i).Cells(ColumnasDelGridItems.Cod_Material).Value Is DBNull.Value Then
                            ...
                            If Not (grdItems.Rows(i).Cells(ColumnasDelGridItems.Cod_Material_Prov).Value Is DBNull.Value) Or _
                                Not (grdItems.Rows(i).Cells(ColumnasDelGridItems.Cod_Material_Prov).Value Is Nothing) Then
                                cod_mat_prov = ""
                            Else
                                cod_mat_prov = grdItems.Rows(i).Cells(ColumnasDelGridItems.Cod_Material_Prov).Value
                            End If
                        ...
                        param_idmarca.Value = Idmarca ' IIf(grdItems.Rows(i).Cells(ColumnasDelGridItems.IdMarca).Value Is DBNull.Value, 0, grdItems.Rows(i).Cells(ColumnasDelGridItems.IdMarca).Value)
                        ...
                        param_idmoneda.Value = grdItems.Rows(i).Cells(ColumnasDelGridItems.IdMoneda).Value 'Idmoneda 'IIf(grdItems.Rows(i).Cells(ColumnasDelGridItems.IdMarca).Value Is DBNull.Value, 0, grdItems.Rows(i).Cells(ColumnasDelGridItems.IdMoneda).Value)
                        ...
                        If grdOfertaComercial.Rows(i).Cells(ColumnasDelGridOfertaComercial.Descripcion).Value <> "" Then
                            ...
                            Try
                                SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "[spPresupuestos_OfertasComerciales_Det_Insert]", _
                                                      param_Id, param_IdPresupuesto_OfertaComercial, param_orden, param_preciosiniva, param_descripcion, param_res)
    ...
    Private Function ControlarCantidadRegistros() As Integer
        ...
        Try
            ...
            If rdTrafo.Checked = False Then
                ...
                '    CantRegistros = grdItems.RowCount - 1
                'Else
                '    CantRegistros = grdItems.RowCount - 2
                'End If

                'For i = 0 To CantRegistros ' grdItems.RowCount - 1
        ...
        Try
            ...
            Try
                SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "spMateriales_Insert", _
                                    ...
                                    param_minimo, param_maximo, param_stockinicial, param_nivel1, param_nivel2, _
