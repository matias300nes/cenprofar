...
Public Class frmPagodeClientes_Contado
    ...
    Private Function AgregarRegistro_FacturasConsumos() As Integer
        ...
        Try
            Try
                ...
                param_idfacturacion.Value = IIf(txtIdFacturacion.Text = "", DBNull.Value, txtIdFacturacion.Text)
                ...
                param_idconsumo.Value = IIf(txtIdConsumo.Text = "", DBNull.Value, txtIdConsumo.Text)
                ...
                param_FechaCanc.Value = FechaVta
                ...
                Try
                    SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "spIngresos_FacturasConsumos_Insert", _
                                              param_idfacturacion, param_idconsumo, param_idingreso, _
                                              param_FechaCanc, param_DEUDA, param_CancelarTodo, param_res)
