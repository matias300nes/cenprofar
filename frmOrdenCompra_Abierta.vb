...
Public Class frmOrdenCompra_Abierta
    ...
    Dim CerrarOCA As Boolean, CerrarOCAPCE As Boolean, CerrarOCAPresup As Boolean
...
#Region "Eventos"
    ...
    Private Sub frmConsumos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If grd.RowCount > 0 Then
            If CBool(grd.CurrentRow.Cells(14).Value) = False Then
                btnCerrar.Enabled = True
                btnCerrarPCE.Enabled = True
                btnCerrarPresup.Enabled = True
                btnHabilitarOCA.Enabled = False
            Else
                btnCerrar.Enabled = False
                btnCerrarPCE.Enabled = True
                btnCerrarPresup.Enabled = True
                btnHabilitarOCA.Enabled = True
            End If
            If CBool(grd.CurrentRow.Cells(14).Value) = True And CBool(grd.CurrentRow.Cells(16).Value) = False Then
                btnCerrar.Enabled = False
                btnCerrarPCE.Enabled = True
                btnCerrarPresup.Enabled = True
                btnHabilitarOCA.Enabled = True
            Else
                If CBool(grd.CurrentRow.Cells(14).Value) = True And CBool(grd.CurrentRow.Cells(16).Value) = True Then
                    btnCerrar.Enabled = False
                    btnCerrarPCE.Enabled = False
                    btnCerrarPresup.Enabled = False
                    'GroupBox1.Enabled = False
                    HabilitarComponentes_GroupBox(False)
                    btnGuardar.Enabled = False
                    btnHabilitarOCA.Enabled = True
                End If
            End If
            If CBool(grd.CurrentRow.Cells(14).Value) = True And CBool(grd.CurrentRow.Cells(17).Value) = True Then
                btnCerrar.Enabled = False
                btnCerrarPCE.Enabled = False
                btnCerrarPresup.Enabled = False
                'GroupBox1.Enabled = False
    ...
    Private Sub frmConsumos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Select Case e.KeyCode
            Case Keys.F3 'nuevo
                If bolModo = True Then
                    If MessageBox.Show("No ha guardado los cambios para el Movimiento actual. ¿Está seguro que desea continuar sin Grabar y hacer un nuevo Movimiento?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                        btnNuevo_Click(sender, e)
                    End If
                Else
                    btnNuevo_Click(sender, e)
            ...
            Case Keys.F6 'grabar
                ...
                End If
            Case Keys.F7 'grabar
                If btnCerrarPCE.Enabled = True Then
                    btnCerrarPCE_Click(sender, e)
                End If
            Case Keys.F8 'grabar
                If btnCerrarPresup.Enabled = True Then
                    btnCerrarPresup_Click(sender, e)
                End If
        End Select
    End Sub
            ...
            Try
                If grd.RowCount > 0 Then
                    If CBool(grd.CurrentRow.Cells(14).Value) = False Then
                        ...
                        HabilitarComponentes_GroupBox(True)
                        btnGuardar.Enabled = True
                        btnHabilitarOCA.Enabled = False
                    Else
                        If CBool(grd.CurrentRow.Cells(14).Value) = True And CBool(grd.CurrentRow.Cells(16).Value) = False And CBool(grd.CurrentRow.Cells(17).Value) = False Then
                            btnCerrar.Enabled = False
                            btnCerrarPCE.Enabled = True
                            btnCerrarPresup.Enabled = True
                            'GroupBox1.Enabled = True
                            ...
                            btnHabilitarOCA.Enabled = True
                        Else
                            If CBool(grd.CurrentRow.Cells(14).Value) = True And CBool(grd.CurrentRow.Cells(16).Value) = True And CBool(grd.CurrentRow.Cells(17).Value) = False Then
                                btnCerrar.Enabled = False
                                btnCerrarPCE.Enabled = False
                                btnCerrarPresup.Enabled = False
                                'GroupBox1.Enabled = False
                ...
                If grd.CurrentRow.Cells(17).Value = True And grd.CurrentRow.Cells(15).Value <> "" Then
                    btnCerrarPresup.Text = "Cerrar OC Abierta / Asociada al Presup " & grd.CurrentRow.Cells(15).Value & " >>"
                    btnCerrar.Enabled = False
                    btnCerrarPCE.Enabled = False
                Else
                    btnCerrarPresup.Text = "Cerrar OC Abierta / Convertir en Presupuesto (F8) >>"
                End If
    ...
    Private Sub BorrarElItemToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BorrarElItemToolStripMenuItem.Click
        ...
        Try
            If cell.Index >= 0 Then 'el de arriba no borraba la fila 0....
                Try
                    If Not (grdItems.CurrentRow.Cells(ColumnasDelGridItems.PreGestion_Codigo).Value Is DBNull.Value) Then
                        Util.MsgStatus(Status1, "El ítem que intenta eliminar está dentro de un remito. Anule el movimiento: " & grdItems.CurrentRow.Cells(ColumnasDelGridItems.PreGestion_Codigo).Value & " en Presupuestos Gestión, para poder eliminar este ítem.", My.Resources.Resources.stop_error.ToBitmap)
                        Util.MsgStatus(Status1, "El ítem que intenta eliminar está dentro de un remito. Anule el movimiento: " & grdItems.CurrentRow.Cells(ColumnasDelGridItems.PreGestion_Codigo).Value & " en Presupuestos Gestión, para poder eliminar este ítem.", My.Resources.Resources.stop_error.ToBitmap, True)
                        Exit Sub
                    End If
    ...
    Private Sub btnCerrarPCE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCerrarPCE.Click
        CerrarOCA = True
        CerrarOCAPCE = True
        btnGuardar_Click(sender, e)
        CerrarOCAPCE = False
        ...
        frmPagodeClientes_Contado.IdCliente = txtIdCliente.Text ''cmbCliente.SelectedValue
        ...
        frmPagodeClientes_Contado.txtIdFacturacion.Text = ""
        frmPagodeClientes_Contado.txtEntregaContado.Text = txtTotal.Text
        frmPagodeClientes_Contado.txtRedondeo.Text = "0"
        frmPagodeClientes_Contado.btnGuardar_Click(sender, e)
    ...
    Private Sub btnCerrarPresup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCerrarPresup.Click

        Dim bandera As String = ""
        Dim CodigoPre As String = ""

        bandera = btnCerrarPresup.Text
        CodigoPre = grd.CurrentRow.Cells(15).Value

        CerrarOCA = True
        CerrarOCAPresup = True
        btnGuardar_Click(sender, e)
        CerrarOCA = False
        CerrarOCAPresup = False

        If InStr(bandera, "Cerrar OC Abierta / Asociada al Presup") > 0 Then
            Select Case Actualizar_Presupuesto(CodigoPre)
                Case -1
                    Util.MsgStatus(Status1, "No se pudo Actualizar el presupuesto asociado.", My.Resources.Resources.stop_error.ToBitmap)
                    Util.MsgStatus(Status1, "No se pudo Actualizar el presupuesto asociado.", My.Resources.Resources.stop_error.ToBitmap, True)
                Case Else
                    Util.MsgStatus(Status1, "Verifique los datos del presupuesto actualizado en la pantalla correspondiente.", My.Resources.Resources.ok.ToBitmap)
                    Util.MsgStatus(Status1, "Verifique los datos del presupuesto actualizado en la pantalla correspondiente.", My.Resources.Resources.ok.ToBitmap, True)
            End Select

        Else

            Dim f As New frmPresupuestos
            f.Origen = 1
            f.Origen_IdCliente = txtIdCliente.Text ''cmbCliente.SelectedValue
            f.Origen_Id = txtID.Text
            f.Origen_OC = txtOCasociado.Text
            f.Origen_Presupuesto = 1
            f.Origen_Cliente = cmbCliente.Text.ToString
            f.Origen_Codigo = txtCODIGO.Text
    ...
    Private Sub btnHabilitarOCA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHabilitarOCA.Click
        If MessageBox.Show("Está seguro que desea Abrir la Orden de Compra Abierta seleccionada?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then

            Dim CodigoPago As Long
            Dim CodigoPre As String = ""

            If Consumos_Pago(CodigoPago, CodigoPre) = 0 Then
                HabilitarComponentes_GroupBox(True)
                If CodigoPre = "" Then
                    btnCerrar.Enabled = True
                    btnCerrarPCE.Enabled = True
                ...
                Else
                    ...
                    btnCerrarPCE.Enabled = False
                    btnCerrarPresup.Enabled = True
                    btnCerrarPresup.Text = "Cerrar OC Abierta / Asociada al Presup " & CodigoPre
                    btnGuardar.Enabled = True
                End If

                btnHabilitarOCA.Enabled = False
            Else
                MsgBox("La OCA fue pagada en el movimiento Nro: " & CodigoPago & ". Anule dicho movimiento para poder abrir la OCA")
            End If
...
#Region "Botones"
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        If MessageBox.Show("¿Desea generar una nueva Orden de Compra Abierta?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If CerrarOCA = True Or CerrarOCAPCE = True Or CerrarOCAPresup = True Then
            Util.MsgStatus(Status1, "Actualizando los precios...", My.Resources.Resources.indicator_white)
            ...
            Dim PrecioAct As Double

            txtSubtotal.Text = "0"

            For i = 0 To CantidadFilas - 1
                If Not (grdItems.Rows(i).Cells(ColumnasDelGridItems.Cod_Material).Value Is DBNull.Value) Then
                    PrecioAct = FormatNumber(ActualizarPrecios(grdItems.Rows(i).Cells(ColumnasDelGridItems.IDMaterial).Value), 2)
                    If PrecioAct <> FormatNumber(grdItems.Rows(i).Cells(ColumnasDelGridItems.PrecioVta).Value, 2) Then
                        grdItems.Rows(i).Cells(ColumnasDelGridItems.preciovtaorig).Value = PrecioAct
                        grdItems.Rows(i).Cells(ColumnasDelGridItems.PrecioVta).Value = PrecioAct
                        'MsgBox("actualizado")
                    End If
                End If

                txtSubtotal.Text = CDbl(txtSubtotal.Text) + CDbl(grdItems.Rows(i).Cells(ColumnasDelGridItems.PrecioVta).Value) * CDbl(grdItems.Rows(i).Cells(ColumnasDelGridItems.Qty).Value)
            Next
            ...
            If bolpoliticas Then
                ...
                Select Case res
                    ...
                    Case 20
                        ...
                        band = 0
                        bolModo = False
                        If CerrarOCAPCE = True Or CerrarOCAPresup = True Then
                            Exit Sub
                        End If
                        btnActualizar_Click(sender, e)
                        Util.MsgStatus(Status1, "El Movimiento se generó correctamente.", My.Resources.Resources.ok.ToBitmap)
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        ...
        nbreformreportes = "Orden de Compra Abierta"
        ...
        paramConsumos.AgregarParametros("Nro OCA: ", "STRING", "", False, txtCODIGO.Text.ToString, "", cnn)
    ...
    Private Overloads Sub btnCancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancelar.Click
        If txtID.Text <> "" Then
            ...
            '    grdItems.Enabled = Not CBool(grd.CurrentRow.Cells(15).Value)
            '    'GroupBox1.Enabled = Not CBool(grd.CurrentRow.Cells(15).Value)
            '    HabilitarComponentes_GroupBox(Not CBool(grd.CurrentRow.Cells(15).Value))

            '    btnCerrar.Enabled = CBool(grd.CurrentRow.Cells(10).Value)
...
#Region "Procedimientos"
    ...
    Private Sub configurarform()
        Me.Text = "Orden de Compra Abierta Interna"
    ...
    Private Sub asignarTags()
        ...
        txtIdCliente.Tag = "8"
        cmbCliente.Tag = "9"
        txtNotaGestion.Tag = "12"
        chkEliminado.Tag = "14"
        chkCerrado.Tag = "15"
        txtOCasociado.Tag = "18"
    ...
    Private Sub BuscarPorcentajeRecargo()
        ...
        Try
            ...
            ds = SqlHelper.ExecuteDataset(connection, CommandType.Text, "SELECT porcrecargo FROM CLIENTES C WHERE id = " & CType(txtIdCliente.Text, Long))
            ds.Dispose()
    ...
    Private Sub HabilitarComponentes_GroupBox(ByVal A As Boolean)
        Label2.Enabled = A
        Label3.Enabled = A
        Label15.Enabled = A
        Label5.Enabled = A
        ...
        dtpFECHA.Enabled = A
        txtIVA.Enabled = A
        cmbCliente.Enabled = A
        PicClientes.Enabled = A
        txtOCasociado.Enabled = A
        cmbVendedor.Enabled = A
        txtNotaGestion.Enabled = A
        chkOcultarGanancia.Enabled = A
        picGanancia.Enabled = A
        grdItems.Enabled = A
        Label10.Enabled = A
        Label7.Enabled = A
        Label8.Enabled = A
...
#Region "Funciones"
    ...
    Private Function ActualizarPrecios(ByVal IdMaterial) As Double
        Dim connection As SqlClient.SqlConnection = Nothing
        ...
        Try
            ...
            Try
                ...
                Dim param_id As New SqlClient.SqlParameter
                param_id.ParameterName = "@idmaterial"
                param_id.SqlDbType = SqlDbType.BigInt
                param_id.Value = IdMaterial
                param_id.Direction = ParameterDirection.Input
                ...
                Try
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spConsumos_ActualizarPrecio", _
                                              param_id, param_precio)

                    ActualizarPrecios = param_precio.Value
    ...
    Private Sub ActualizarSubtotal()
        ...
        Try
            ...
            Try
                ...
                Try
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spConsumos_ActualizarSubtotales", _
                                              param_id)
    ...
    Private Function AgregarActualizar_Registro() As Integer
        ...
        Try
            ...
            Try
                ...
                Dim param_OCAbiertaAsociada As New SqlClient.SqlParameter
                param_OCAbiertaAsociada.ParameterName = "@OCAbiertaAsociada"
                param_OCAbiertaAsociada.SqlDbType = SqlDbType.VarChar
                param_OCAbiertaAsociada.Size = 50
                param_OCAbiertaAsociada.Value = txtOCasociado.Text
                param_OCAbiertaAsociada.Direction = ParameterDirection.Input
                ...
                param_cancelado.Value = CerrarOCAPCE
                ...
                param_Deuda.Scale = 2
                param_Deuda.Value = IIf(CerrarOCAPCE = True, 0, txtTotal.Text)
                ...
                If InStr(btnCerrarPresup.Text, "Cerrar OC Abierta / Asociada al Presup") > 0 Then
                    param_presupuesto.Value = True
                Else
                    param_presupuesto.Value = CerrarOCAPresup
                End If
                ...
                Try
                    If bolModo = True Then
                        SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "sp_Consumos_Insert", _
                                            param_id, param_fecha, param_codigo, param_idCliente, param_OCAbiertaAsociada, _
                                            param_subtotal, param_iva, param_montoiva, param_totalconsumo, param_facturado, _
                                            param_cerrado, param_idvendedor, _
                                            param_RecDescGlobal, param_RecargoDesc, param_porcrecargo, param_nota, _
                                            param_Deuda, param_cancelado, param_presupuesto, param_useradd, param_res)
                    ...
                    Else
                        SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "sp_Consumos_Update", _
                                            param_id, param_fecha, param_idCliente, param_OCAbiertaAsociada, _
                                            param_subtotal, param_iva, param_montoiva, param_totalconsumo, param_facturado, _
                                            param_cerrado, param_idvendedor, _
                                            param_RecDescGlobal, param_RecargoDesc, param_porcrecargo, param_nota, _
                                            param_Deuda, param_cancelado, param_presupuesto, param_useradd, param_res)
            ...
            Try
                ...
                Do While i < CantidadFilas
                    ...
                    If grdItems.Rows(i).Cells(ColumnasDelGridItems.Cod_Material).Value Is DBNull.Value Then
                        ...
                        If ControlarNombreProducto(grdItems.Rows(i).Cells(ColumnasDelGridItems.Nombre_Material).Value, ConnStringSEI) >= 1 Then
                            Util.MsgStatus(Status1, "El producto " & grdItems.Rows(i).Cells(ColumnasDelGridItems.Nombre_Material).Value & " ya existe. Por favor, verifique la carga que está realizando", My.Resources.Resources.stop_error.ToBitmap)
                            Util.MsgStatus(Status1, "El producto " & grdItems.Rows(i).Cells(ColumnasDelGridItems.Nombre_Material).Value & " ya existe. Por favor, verifique la carga que está realizando", My.Resources.Resources.stop_error.ToBitmap, True)
                        ...
                        id = Agregar_Material(unidad, Nothing, nombre, precio, 0, PrecioLista, Ganancia)
                    ...
                    Try
                        If bolModo = True Then
                            SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "sp_Consumos_Det_Insert", _
                                                  ...
                                                  param_RecargoDesc, param_porcrecargo, param_useradd, param_OrdenItem, _
    ...
    Private Function EliminarItems_Consumo() As Integer
        ...
        Try
            ...
            SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "spConsumos_EliminarItems_Det", _
                                        param_id, param_useradd, param_MENSAJE, param_res)
    ...
    Private Function Actualizar_Presupuesto(ByVal codigopre As String) As Integer
        Dim connection As SqlClient.SqlConnection = Nothing
        ...
        Try
            ...
            Dim param_CodigoPre As New SqlClient.SqlParameter
            param_CodigoPre.ParameterName = "@CodigoPres"
            param_CodigoPre.SqlDbType = SqlDbType.BigInt
            param_CodigoPre.Value = codigopre
            param_CodigoPre.Direction = ParameterDirection.Input
            ...
            SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spConsumos_Actualizar_Presupuesto", _
                                        param_id, param_CodigoPre, param_res)

            Actualizar_Presupuesto = param_res.Value
    ...
    Private Function Agregar_Material(ByVal Unidad As Long, ByVal Codigo As String, ByVal Nombre As String, _
                                     ...
                                     ByVal Ganancia As Double) As Long
        Dim res As Integer = 0
    ...
    Private Function Agregar_Proveedor(ByVal idmaterial As Long, ByVal IdUnidad As Long, _
        ...
        Try
            SqlHelper.ExecuteNonQuery(tran, CommandType.StoredProcedure, "sp_Materiales_Proveedor_Det_Insert", _
                                      ...
                                      param_preciolista, param_preciovtasiniva, param_iva, param_res)
    ...
    Private Function Consumos_Pago(ByRef NroPago As Long, ByRef NroPre As String) As Integer
        ...
        Try
            ...
            param_NroPago.ParameterName = "@NroPago"
            param_NroPago.SqlDbType = SqlDbType.BigInt
            param_NroPago.Value = DBNull.Value
            param_NroPago.Direction = ParameterDirection.InputOutput

            Dim param_NroPre As New SqlClient.SqlParameter
            param_NroPre.ParameterName = "@CodigoPre"
            param_NroPre.SqlDbType = SqlDbType.VarChar
            param_NroPre.Size = 25
            param_NroPre.Value = DBNull.Value
            param_NroPre.Direction = ParameterDirection.InputOutput
            ...
            Try
                SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spConsumos_Pagos_Controlar", _
                                    param_id, param_NroPago, param_NroPre, param_res)

                NroPre = param_NroPre.Value

                If param_res.Value > 0 Then
                    NroPago = param_NroPago.Value
                End If

                Consumos_Pago = param_res.Value
