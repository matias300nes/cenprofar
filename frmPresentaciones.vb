...
Public Class frmPresentaciones
    ...
    Enum ColumnasDelGridPresentaciones
        Id = 0
        IdObraSocial = 1
        IDFarmacia = 2
        Farmacia = 3
...
#Region "Eventos"
    ...
    Private Sub frmPresentaciones_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
...
#Region "Procedimientos"
    ...
    Private Sub LlenarGridItems(ByVal id As Long)
        ...
        grdItems.Columns(ColumnasDelGridPresentaciones.Eliminado).Visible = False
        grdItems.Columns(ColumnasDelGridPresentaciones.DateAdd).Visible = False
        grdItems.Columns(ColumnasDelGridPresentaciones.UserAdd).Visible = False
        grdItems.Columns(ColumnasDelGridPresentaciones.DateUpd).Visible = False
        grdItems.Columns(ColumnasDelGridPresentaciones.UserUpd).Visible = False
        grdItems.Columns(ColumnasDelGridPresentaciones.DateDel).Visible = False
        grdItems.Columns(ColumnasDelGridPresentaciones.UserDel).Visible = False


        grdItems.Columns(ColumnasDelGridPresentaciones.Id).Visible = True

        grdItems.Columns(ColumnasDelGridPresentaciones.IdObraSocial).Visible = True

        grdItems.Columns(ColumnasDelGridPresentaciones.IDFarmacia).ReadOnly = False  'Codigo material
        grdItems.Columns(ColumnasDelGridPresentaciones.IDFarmacia).Width = 70

        'grdItems.Columns(ColumnasDelGridPresentaciones.Nombre_Material).ReadOnly = True 'Material
        grdItems.Columns(ColumnasDelGridPresentaciones.Farmacia).Width = 260

        grdItems.Columns(ColumnasDelGridPresentaciones.Receta).ReadOnly = True 'qty
        grdItems.Columns(ColumnasDelGridPresentaciones.Receta).Width = 70
        grdItems.Columns(ColumnasDelGridPresentaciones.Receta).Visible = True

        grdItems.Columns(ColumnasDelGridPresentaciones.ImpTotal).Visible = False

        grdItems.Columns(ColumnasDelGridPresentaciones.ImpEntidad).ReadOnly = True
        grdItems.Columns(ColumnasDelGridPresentaciones.ImpEntidad).Width = 60
        grdItems.Columns(ColumnasDelGridPresentaciones.ImpEntidad).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter

        grdItems.Columns(ColumnasDelGridPresentaciones.Bonificacion).ReadOnly = True 'Unidad'
        grdItems.Columns(ColumnasDelGridPresentaciones.Bonificacion).Width = 70
        'grdItems.Columns(ColumnasDelGridPresentaciones.Unidad).Visible = False

        grdItems.Columns(ColumnasDelGridPresentaciones.APagar).ReadOnly = True 'stock'
        grdItems.Columns(ColumnasDelGridPresentaciones.APagar).Width = 50

        'grdItems.Columns(ColumnasDelGridPresentaciones.Minimo).Visible = False

        'grdItems.Columns(ColumnasDelGridPresentaciones.Maximo).Visible = False

        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioLista).ReadOnly = True
        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioLista).Width = 55
        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioLista).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        'grdItems.Columns(ColumnasDelGridPresentaciones.Ganancia).Width = 50
        'grdItems.Columns(ColumnasDelGridPresentaciones.Ganancia).ReadOnly = True
        'grdItems.Columns(ColumnasDelGridPresentaciones.Ganancia).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioUni).ReadOnly = True 'precio unitario
        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioUni).Width = 60
        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioUni).Visible = False
        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioUni).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioVta).ReadOnly = True 'precio unitario
        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioVta).Width = 60
        'grdItems.Columns(ColumnasDelGridPresentaciones.PrecioVta).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        'grdItems.Columns(ColumnasDelGridPresentaciones.RecDesc).Width = 70
        'grdItems.Columns(ColumnasDelGridPresentaciones.RecDesc).ReadOnly = False 'precio unitario
        'grdItems.Columns(ColumnasDelGridPresentaciones.RecDesc).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter

        'grdItems.Columns(ColumnasDelGridPresentaciones.PorcRecDesc).Width = 60
        'grdItems.Columns(ColumnasDelGridPresentaciones.PorcRecDesc).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        'grdItems.Columns(ColumnasDelGridPresentaciones.Qty).ReadOnly = False 'maximo'
        'grdItems.Columns(ColumnasDelGridPresentaciones.Qty).Width = 60
        'grdItems.Columns(ColumnasDelGridPresentaciones.Qty).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter

        'grdItems.Columns(ColumnasDelGridPresentaciones.SubTotalProd).ReadOnly = True 'subtotal
        'grdItems.Columns(ColumnasDelGridPresentaciones.SubTotalProd).Width = 70
        'grdItems.Columns(ColumnasDelGridPresentaciones.SubTotalProd).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        'grdItems.Columns(ColumnasDelGridPresentaciones.dateupd).ReadOnly = True 'maximo'
        'grdItems.Columns(ColumnasDelGridPresentaciones.dateupd).Width = 80
        'grdItems.Columns(ColumnasDelGridPresentaciones.dateupd).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter

        'grdItems.Columns(ColumnasDelGridPresentaciones.preciovtaorig).Visible = False
        'grdItems.Columns(ColumnasDelGridPresentaciones.gananciaorig).Visible = False

        'grdItems.Columns(ColumnasDelGridPresentaciones.nota_det).Width = 250
        ...
        For Each row As DataGridViewRow In Me.grdItems.Rows
            Total += Val(row.Cells(ColumnasDelGridPresentaciones.APagar).Value) 'ROW.CELLS (NUMERO DE LA COLUMNA A SUMAR).VALUE
        Next
        Me.txtTotalAPagar.Text = Total.ToString
